...
Welcome to ``radio81`` contributor's guide.
...
If you experience bugs or general issues with ``radio81``, please have a look
...
You can help improve ``radio81`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``radio81`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``radio81``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n radio81 python=3 six virtualenv pytest pytest-cov
    conda activate radio81
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/radio81.git
    cd radio81
...
#. Install |pre-commit|_::
   ...
   ``radio81`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/radio81
.. _issue tracker: https://github.com/<USERNAME>/radio81/issues
.. <-- end -->
